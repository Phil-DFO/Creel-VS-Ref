...
Interviews <- read.csv(here::here("data", "Ref_Interveiws_2324.csv"))

Logs <- read.csv(here::here("data", "Ref_Logs_2324.csv"))
...
write.csv(Size_Proportions_Month_Sub, file = "Y:/Fishery_Monitor/Mark Selective Fishery monitoring/MSF Reference Fisheries/Creel VS RF/Raw data/Prepped Data/Size_Proportions_Month_Sub(Raw Creel Data).csv")


write.csv(Size_Proportions_Month_Sub, here::here("data", "Size_Proportions_Month_Sub(Raw Creel Data).csv"), row.names = FALSE)
