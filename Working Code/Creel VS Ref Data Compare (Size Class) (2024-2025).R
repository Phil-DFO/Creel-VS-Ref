...
Creel_Catch2023 <- read.csv("Y:/Fishery_Monitor/Mark Selective Fishery monitoring/MSF Reference Fisheries/Creel VS RF/Raw data/Prepped Data/Catch_est_CreelVsRef(2023).csv")

Creel_Catch2024 <- read.csv("Y:/Fishery_Monitor/Mark Selective Fishery monitoring/MSF Reference Fisheries/Creel VS RF/Raw data/Prepped Data/Catch_est_CreelVsRef(2024).csv")

Creel_Catch2025 <- read.csv("Y:/Fishery_Monitor/Mark Selective Fishery monitoring/MSF Reference Fisheries/Creel VS RF/Raw data/Prepped Data/Catch_est_CreelVsRef(2025).csv")

Creel_Catch <- rbind(Creel_Catch2023, Creel_Catch2024, Creel_Catch2025)
...
write.csv(Size_Proportions_Month_Sub, file = "Y:/Fishery_Monitor/Mark Selective Fishery monitoring/MSF Reference Fisheries/Creel VS RF/Raw data/Prepped Data/Size_Proportions_Month_Sub(2023-2025).csv")
