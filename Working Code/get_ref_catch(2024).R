...
#Bute & Toba
Bute_Toba_Catch <- ests %>% filter(creelsub %in% Bute_Toba, month %in% Bute_Toba_Months, species == "Chinook", year == 2024) %>%
...
write.csv(est5, "Y:/Fishery_Monitor/Mark Selective Fishery monitoring/MSF Reference Fisheries/Creel VS RF/Raw data/Prepped Data/Catch_est_CreelVsRef(2024).csv")
